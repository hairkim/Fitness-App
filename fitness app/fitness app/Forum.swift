...
struct ForumView: View {
    ...
    private func addQuestion(title: String, body: String, media: [MediaItem], link: URL?) {
        let newPost = ForumPost(username: "user name", title: title, body: body, replies: [], media: media, link: link)
        posts.append(newPost)
        isShowingQuestionForm = false // Hide the question form after adding the post
    }
